...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // ✅ Create role_has_permissions table (Pivot Table)
        ...
        // ✅ Create model_has_roles table (Assigning roles to users)
        ...
        // ✅ Create model_has_permissions table (Assigning permissions directly to users/models)
