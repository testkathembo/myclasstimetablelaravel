          ...
          <div className="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-lg font-medium text-gray-900">
                Preview Notifications for {exam.unit.code}
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white border rounded-lg shadow-sm md:col-span-1">
                ...
                <div className="p-4 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="font-medium">{formatDate(exam.date)} ({exam.day})</div>
                    <div className="text-sm">{exam.start_time} - {exam.end_time}</div>
                  </div>
              ...
              <div className="bg-white border rounded-lg shadow-sm md:col-span-2">
                <div className="p-4 border-b">
                  ...
                  <p className="text-sm text-gray-500">
                    {studentCount} students will receive notifications
                  </p>
                </div>
                <div className="p-4">
                ...
                <div className="p-4">
                  <div className="border rounded-md p-4 bg-gray-50">
                    ...
                    <div className="space-y-4">
                      ...
                      <p>We wish to remind you that you will be having an exam tomorrow. Please keep checking your timetable for further details.</p>
                      
                      <div className="border-l-4 border-gray-300 pl-4">
                        <p className="font-bold">Exam Details:</p>
                        <p><strong>Unit:</strong> {exam.unit.code} - {exam.unit.name}</p>
                        <p><strong>Date:</strong> {formatDate(exam.date)} ({exam.day})</p>
                        <p><strong>Time:</strong> {exam.start_time} - {exam.end_time}</p>
                        <p><strong>Venue:</strong> {exam.venue} - {exam.location}</p>
                      </div>
                      
                      <p>We wish you all the best in your preparation!</p>
                    </div>
                  </div>
                </div>
              </div>
