...
export default function StudentEnroll({ semesters, groups, classes, units, student, enrollments }: Props) {
    ...
    const handleClassChange = async (classId: number) => {
        ...
        if (currentEnrollment.semester_id) {
            try {
                const response = await axios.post("/api/units/by-class-and-semester", {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post("/enroll", currentEnrollment, {
            onSuccess: () => {
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) => setCurrentEnrollment(prev => ({ 
                                ...prev, 
